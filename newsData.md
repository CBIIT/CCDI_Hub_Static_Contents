...
# July 2026 CCDI Hub updates
### July 7, 2026 | News

| | |
| --- | --- |
| <p>The <a href="https://ccdi.cancer.gov/MCI">Molecular Characterization Initiative (MCI) page</a> has been updated with the latest information on testing types, results reporting, and contact information, and the enrollment counts have been updated as of June 8, 2026. A typo in the filename of the ineligible patient list for MCI has also been corrected. Three events have been added to the <a href="https://ccdi.cancer.gov/ccdi-events-announcements">CCDI Events Announcements page</a>. The 2.11.0 release note was corrected to clarify a feature that had not yet been included at the time of release. </p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_Misc_News.png" width="220" alt="updateImgMiscNews"> |
...
# 6 new resources and over 10 new datasets
### June 16, 2026 | CCDI Application Updates

| | |
| --- | --- |
| <p>The <a href="https://datacatalog.ccdi.cancer.gov/">Childhood Cancer Data Initiative Data Catalog</a> Version 1.5.9 was released on 6/10/2026, adding 6 new resources and 12 new datasets from existing resources. Links to analytic tools were also added to several resources.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_CCDC.png" width="220" alt="updateImgCCDC"> |

| Property | Value |
| --- | --- |
| id | ccdc_06102026 |
| slug | The June Childhood Cancer Data Catalog (CCDC) release added 6 new resources and 12 new datasets from existing resources |

---

# May 2026 CCDI Hub updates
### May 20, 2026 | News

| | |
| --- | --- |
| <p>Two new publications have been added to the <a href="https://ccdi.cancer.gov/publications">CCDI-Supported Publications list</a>, and three previously reported preprints have been updated with their final publication details. The NCH-IGM ClinVar Submitter’s Page has been added to <a href="https://ccdi.cancer.gov/tools">CCDI Hub's Tools list</a>, and tools from the Modeling Outcomes Using Surveillance Data and Scalable AI for Cancer (MOSSAIC) Project have been moved to the CCDI-supported tools section. The <a href="https://ccdi.cancer.gov/MCI">Molecular Characterization Initiative (MCI) page</a> has also been updated with enrollment counts as of May 7, 2026.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_Misc_News.png" width="220" alt="updateImgMiscNews"> |

| Property | Value |
| --- | --- |
| id | hub_05202026 |
| slug | Two new publications, one new tool, and updated MCI enrollment |

---

# 15 new resources and additional resource updates
### May 20, 2026 | CCDI Application Updates

| | |
| --- | --- |
| <p>Version 1.5.8 of the Childhood Cancer Data Initiative Data Catalog added 15 new resources and 4 new datasets from existing resources. Additional updates were made to resource counts, grant information, publications, and more. <i>[Edited 6/16/2026 to correct typo in resource name]</i></p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_CCDC.png" width="220" alt="updateImgCCDC"> |

| Property | Value |
| --- | --- |
| id | ccdc_04232026 |
| slug | April’s Childhood Cancer Data Catalog (CCDC) release added 15 new resources and 4 new datasets from existing resources |
...
| | |
| --- | --- |
| <p>The Childhood Cancer Data Catalog (CCDC)’s last update of 2025 features the annual update to GENIE’s data set plus a new resource, the Pediatric Cancer Registry \| Florida Association of Pediatric Tumor Programs, Inc. (FAPTP). Resource contact links have been updated to better indicate whether the contact is an email address or an external web page.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_CCDC.png" width="220" alt="updateImgCCDC"> |
...
| | |
| --- | --- |
| <p>The CCDI’s Texas Pediatric Patient Derived Xenograft is the newest data set to be added to the Childhood Cancer Data Catalog (CCDC). Eleven existing resources have also been updated to reflect the latest counts, disease lists, publications, and URLs.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_CCDC.png" width="220" alt="updateImgCCDC"> |
...
| | |
| --- | --- |
| <p>The CCDI Hub's <a href="https://ccdi.cancer.gov/publications">CCDI-Supported Publications list</a> has been updated with four new publications and the <a href="https://ccdi.cancer.gov/MCI">Molecular Characterization Initiative (MCI) page</a> has been updated with enrollment counts for the month of October.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_Misc_News.png" width="220" alt="updateImgMiscNews"> |
...
| | |
| --- | --- |
| <p>The CCDI Hub's <a href="https://ccdi.cancer.gov/MCI">Molecular Characterization Initiative (MCI) page</a> has been updated with September enrollment counts and a new article about the Open Pediatric Cancer Project has been added to the <a href="https://ccdi.cancer.gov/publications">CCDI-Supported Publications list</a>.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_Misc_News.png" width="220" alt="updateImgMiscNews"> |
...
| | |
| --- | --- |
| <p>The first CCDC release of 2025 introduces a new resource and accompanying data set from NCI National Clinical Trials Network (NCTN) Biobanks. Explore the NCTN Biobanks data set along with a new dbGaP data set: Genomic Profiling of Pediatric B-Cell Acute Lymphoblastic Leukemia. Additionally, this release includes updated counts to data sets in six resources across the catalog. The user guide has also undergone extensive updates, with improved content and images to more accurately describe the application and its resources.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_CCDC.png" width="220" alt="updateImgCCDC"> |
...
| | |
| --- | --- |
| <p>The latest update to the CCDI Hub includes six new data sets. Enhancements to the Explore Dashboard improve filtered search functionality, notably with a text search capability for the Diagnosis and Diagnosis Anatomic Site facets. A new Export button allows direct export from the Cart to the Velsera Cancer Genomics Cloud platform for further analysis. This release also introduces a new CCDI-Supported Publications page. Updates to existing pages include enhancements to the About Page, updated Hub User Guide, NCCR Data Platform links from the homepage, and the updated MCI enrollments report for November.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_Release_Notes.png" width="220" alt="updateImgReleaseNotes"> |
...
| | |
| --- | --- |
| <p>The CCDI Hub has added four new data sets and updated two existing data sets (the CCDI Molecular Characterization Initiative and Pediatric Brain Tumor Atlas). In adding these, the Hub gains new data from over 1,600 participants and 3,100 samples, along with 30,000 new files.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_Release_Notes.png" width="220" alt="updateImgReleaseNotes"> |
...
| | |
| --- | --- |
| <p>Now part of the CCDC: the cBioPortal for Cancer Genomics, a tool for interactive exploration of genomics data sets that aims to lower barriers to accessing complex genomic data. This release also includes the Innovative Therapies for Children with Cancer Paediatric Preclinical Proof-of-Concept Platform (ITCC-P4). The ITCC-P4 platform, developed through an academic-industry partnership, aims to establish new patient-derived preclinical models of high-risk pediatric tumors and help speed up drug development for childhood cancers.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_New_Application_Release.png" width="220" alt="updateImgNewApplicationRelease"> |
...
| | |
| --- | --- |
| <p>Do you have capabilities in automated electronic health record (EHR) data entry and extraction? If so, please respond to our latest Request for Information and share your tools, clinical workflows, and approaches for entering and extracting EHR data in a structured format. Your input could help NCI plan a workshop on this topic. <a class="link" href="https://grants.nih.gov/grants/guide/notice-files/NOT-CA-24-021.html" target="_blank" rel="noopener noreferrer">Submit responses by February 29, 2024. https://grants.nih.gov/grants/guide/notice-files/NOT-CA-24-021.html</a></p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_EHR.png" width="220" alt="updateImgEHR"> |
...
| | |
| --- | --- |
| <p>The Cancermodels.org resource has been added to the CCDI Childhood Cancer Data Catalog. This is a free, open-source platform that collects clinical, genomic, and functional data from patient-derived xenografts, organoids, and cell lines. The catalog update also includes 13 new datasets, eight of which are from the Single-cell Pediatric Cancer Atlas Portal (ScPCA).</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_CCDC.png" width="220" alt="updateImgCCDC"> |
...
| | |
| --- | --- |
| <p>NCI hosted the CCDI Symposium on March 24, 2023, which brought together hundreds of members of the childhood cancer community. The event featured presentations on CCDI Data Ecosystem progress by Drs. Anthony Kerlavage and Subhashini Jagu.</p><p><a href="https://www.cancer.gov/research/areas/childhood/childhood-cancer-data-initiative/events-webinars/symposium-0" target="_blank" rel="noopener noreferrer">View the event presentation</a> and <a href="https://videocast.nih.gov/watch=49171" target="_blank" rel="noopener noreferrer">watch the recording</a>.</p> | <img src="https://raw.githubusercontent.com/CBIIT/CCDI_Hub_Assets/main/Image/News/News_Symposium.png" width="220" alt="updateImgSymposium"> |
