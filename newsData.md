...
**title**: Three new resources and over 40 new data sets in the CCDI Data Catalog
...
**highlight**: <p>The CONCORD*Explorer, NF Data Portal, and scMINER resources were added to the CCDC with 16 new data sets as part of the 1.5.7 release. 32 new data sets were also added to existing resources, with notable additions to cBioPortal, Gene Expression Omnibus (GEO), and dbGaP. Counts, dbGaP accessions, and references were updated for numerous other resources and “Available Files” links to download clinical data were added to four more TARGET data sets.</p>
...
**title**: Annual GENIE update now available in the Childhood Cancer Data Catalog

**date**: December 16, 2025

**slug**: Last release of the year adds one new resource and updated contact information

**highlight**: <p>The Childhood Cancer Data Catalog (CCDC)’s last update of 2025 features the annual update to GENIE’s data set plus a new resource, the Pediatric Cancer Registry | Florida Association of Pediatric Tumor Programs, Inc. (FAPTP). Resource contact links have been updated to better indicate whether the contact is an email address or an external web page.</p>
...
**title**: Fall CCDC update adds another data set

**date**: December 16, 2025

**slug**: One new data set and eleven updated resources in the CCDC 

**highlight**: <p>The CCDI’s Texas Pediatric Patient Derived Xenograft is the newest data set to be added to the Childhood Cancer Data Catalog (CCDC). Eleven existing resources have also been updated to reflect the latest counts, disease lists, publications, and URLs.</p>
...
**title**: October 2025 CCDI Hub updates

**date**: November 17, 2025

**slug**: Browse the latest MCI enrollment and publications

**highlight**: <p>The CCDI Hub's <a href="https://ccdi.cancer.gov/publications">CCDI-Supported Publications list</a> has been updated with four new publications and the <a href="https://ccdi.cancer.gov/MCI">Molecular Characterization Initiative (MCI) page</a> has been updated with enrollment counts for the month of October.</p>
...
**title**: August marks 30th CCDC release

**date**: September 12, 2025

**slug**: 30th CCDC release continues tradition of steady progress

**highlight**: <p>The CCDI cBioPortal Cancer Data Explorer is the latest tool resource to be added to the Childhood Cancer Data Catalog (CCDC). In this same release, four existing resources were updated along with restoring removed data sets. The <a href="https://datacatalog.ccdi.cancer.gov/User%20Guide%20for%20CCDC%20v1.5.3.pdf">CCDC User Guide</a> has been revised to include all of these changes.</p>
...
### molecularcharacterization_07202023
...
### hub_release_02192026

**id**: hub_release_02192026

**title**: CCDI Hub Release 2.9.2
...
### hub_release_01082025

**id**: hub_release_01082025

**title**: CCDI Hub Release 2.9.1
...
### hub_release_12162025

**id**: hub_release_12162025

**title**: CCDI Hub Release 2.9.0
...
### hub_release_09122025

**id**: hub_release_09122025

**title**: CCDI Hub Release 2.8.0
...
### hub_release_08042025

**id**: hub_release_08042025

**title**: CCDI Hub Release 2.7.1
...
### hub_release_06302025

**id**: hub_release_06302025

**title**: CCDI Hub Release 2.7.0
...
### hub_release_05142025

**id**: hub_release_05142025

**title**: CCDI Hub Minor Release 2.6.1
